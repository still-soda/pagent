...
import type { DomainVault, PageConversation, PageConversationStore, VaultMap } from '@/shared/contracts/session';
...
export function viewForVault(
  ...
  if (!live || (isSparseStore(live) && live.conversations.length <= 1)) {
