...
function LiveStreamingText({
  ...
  return (
    <div className={fill ? "w-full" : "min-h-0 w-full"}>
...
export default function StreamingText({
  ...
  if (text != null) {
    return <LiveStreamingText fill={fill} text={text} streaming={streaming} />;
  }
  return <DemoStreamingText loop={loop} fill={fill} onDone={onDone} />;
}
