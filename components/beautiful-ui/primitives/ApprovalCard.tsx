                  ...
                  >
                    <span
                      className={`flex size-4 shrink-0 items-center justify-center transition-colors duration-200
                        ...
                        ${on ? "bg-primary text-primary-foreground" : "shadow-[inset_0_0_0_1.5px_var(--line-strong)] text-transparent"}`}
                    >
                      {question.type === "radio" ? (
        ...
        <div className="primitive-card-footer flex items-center justify-between">
          ...
          {!sent && (
            <button
              ...
              style={{
                background: hasAnswer ? "var(--primary)" : "var(--field)",
                color: hasAnswer ? "var(--primary-foreground)" : "var(--ink-3)",
